...
def test_check_boundary_warning():
    ...
    with patch.object(logger, "warning") as mock_warning:
        ...
        expected_calls = [
            call("The following parameters have boundaries > 10σ from their prior nominal"),
            call("   'param_a' | Nominal: 1.000000, Error 0.100000 | Lower Bnd -100.000000, Upper Bnd 1.000000"),
            call("   'param_b' | Nominal: 2.000000, Error 0.100000 | Lower Bnd 2.000000, Upper Bnd 100.000000"),
        ]
